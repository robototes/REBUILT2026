...
public class AutoLogic {
  ...
  public enum StartPosition {
    LEFT_TRENCH(
        "Left Trench", new Pose2d(4.014, 7.582, new Rotation2d(Units.degreesToRadians(90)))),
    ...
    RIGHT_TRENCH(
        "Right Trench", new Pose2d(3.641, 0.478, new Rotation2d(Units.degreesToRadians(-90)))),
    MISC("Misc", null);
