...
public class PhotonToLimelightConverter {
  ...
  public static void convertRawFiducials(
      List<PhotonTrackedTarget> targets, Transform3d robotToCamera, LimelightData data) {
  ...
  /**
   * Build the botpose array in Limelight format from robot pose and target data. Format: [x, y, z,
   * roll, pitch, yaw, latency, tagCount, tagSpan, avgDist, avgArea, ...rawFiducials]
   */
  @SuppressWarnings("checkstyle:VariableDeclarationUsageDistance")
